export default async function handler(req: any, res: any) {
  try {
    ...
    const toolSlugs = [
      "caption-moji-ai", "text-case-in", "face-swap", "bg-remover", "enhancer", "compressor", 
      ...
      "ai-text-humanizer", "ai-paraphraser", "ai-plagiarism-remover", "ai-text-summarizer", 
      "ai-caption-generator", "ai-script-generator"
    ];
