  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="text-center mb-16">
        <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">{t.legal.contactTitle}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div>
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm mb-8">
            ...
            <a href="mailto:support@texly.online" className="text-xl font-bold text-blue-600 hover:underline">
              ...
              >
                {loading ? (
                  ...
                  <>
                    ...
                    {t.legal.formSubmit || 'Send Message'}
                  </>
                )}
              </button>
            </form>
