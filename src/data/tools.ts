...
export const TOOLS: Tool[] = [
  {
    id: 'caption-moji-ai',
    name: 'Caption Moji AI (AI Caption Generator ⚡)',
    slug: 'caption-moji-ai',
    category: 'generator',
    shortDescription: 'Generate AI captions for your social media posts instantly.',
    description: 'Caption Moji AI is an AI-powered caption generator that helps you create engaging captions for Instagram, Facebook, and more.',
    icon: 'Sparkles',
    keywords: ['ai caption generator', 'social media captions', 'instagram caption generator', 'ai text generator'],
    externalUrl: 'https://www.captionmojiai.online',
    process: (s) => s
  },
  {
    id: 'text-case-in',
    name: 'TextCase.in (Advanced Text Converter ⚡)',
    slug: 'text-case-in',
    category: 'converter',
    shortDescription: 'Advanced text case converter and formatter online.',
    description: 'TextCase.in provides a wide range of text conversion and formatting tools to help you manage your text efficiently.',
    icon: 'RefreshCw',
    keywords: ['text case converter', 'text formatter', 'online text tool', 'case converter'],
    externalUrl: 'https://textcase.in',
    process: (s) => s
  },
  // AI TOOLS
  {
...
const AI_TEXT_TOOLS: Tool[] = [
  {
    id: 'ai-humanizer',
    name: 'AI Text Humanizer - Bypass AI Detection Free ⚡',
    slug: 'ai-text-humanizer',
    category: 'ai',
    isAI: true,
    shortDescription: 'Rewrite AI-generated text to sound 100% human and bypass detectors.',
    description: 'Bypass AI detectors like GPTZero, Originality.ai, and Turnitin with Texly\'s Free AI Text Humanizer. Our tool rewrites AI content to make it sound natural, conversational, and completely human-like while preserving the original meaning. Ideal for students, content creators, and bloggers.',
    icon: 'User',
    keywords: ['ai text humanizer online free', 'bypass ai detection tool', 'humanize ai content free', 'rewrite ai text to human', 'best ai humanizer no login', 'humanize chatgpt text free'],
    example: 'In conclusion, the data demonstrates that artificial intelligence is playing an increasingly vital role in modern software development, significantly improving efficiency across various sectors.',
    ...
    process: async (input) => {
       const response = await fetch('/api/ai/text', {
         ...
         body: JSON.stringify({ input, toolId: 'ai-humanizer' })
       });
       const data = await response.json();
       return data.result || 'AI humanization failed.';
    }
  },
  {
    id: 'ai-paraphraser',
    name: 'AI Professional Paraphraser - Best Free Rewriting Tool ⚡',
    slug: 'ai-paraphraser',
    category: 'ai',
    isAI: true,
    shortDescription: 'Rewrite sentences and paragraphs professionally for better flow.',
    description: 'Texly\'s AI Paraphraser is the best free tool to rewrite sentences and paragraphs online. Improve your writing flow, vocabulary, and clarity instantly with professional-grade AI rewriting. Perfect for academic writing, emails, and professional documentation. 100% free, no sign-up required.',
    icon: 'RefreshCw',
    keywords: ['ai paraphraser online free', 'best free rewriting tool', 'online paraphrase tool ai', 'rewrite sentences professionally', 'article rewriter online free', 'sentence rephraser free'],
    example: 'The implementation of the new policy resulted in significant improvements in production efficiency across the entire manufacturing department.',
    placeholder: 'Enter text to paraphrase professionally...',
    buttonText: 'Paraphrase Now ✨',
    process: async (input) => {
       const response = await fetch('/api/ai/text', {
         method: 'POST',
         headers: { 'Content-Type': 'application/json' },
         body: JSON.stringify({ input, toolId: 'ai-paraphraser' })
       });
       const data = await response.json();
       return data.result || 'Paraphrasing failed.';
    }
  },
  {
    id: 'ai-plagiarism-remover',
    name: 'AI Plagiarism Remover - Unique Content Rewriter Free ⚡',
    slug: 'ai-plagiarism-remover',
    category: 'ai',
    isAI: true,
    shortDescription: 'Remove plagiarism from your text by rewriting it uniquely with AI.',
    description: 'Ensure your content is 100% unique with Texly\'s AI Plagiarism Remover. Our advanced rewriter changes sentence structures and wording completely to help you avoid copy-paste matching while keeping the original information intact. Reliable, fast, and completely free plagiarism rewriter.',
    icon: 'FileCheck',
    keywords: ['ai plagiarism remover online', 'unique content rewriter free', 'how to remove plagiarism with ai', 'original text generator free', 'best plagiarism fixer tool', 'remove plagiarism from essay free'],
    example: 'Social media has revolutionized communication by allowing individuals to connect across vast distances in real-time.',
    placeholder: 'Paste text with potential plagiarism to rewrite it uniquely...',
    buttonText: 'Fix Plagiarism ✨',
    process: async (input) => {
       const response = await fetch('/api/ai/text', {
         method: 'POST',
         headers: { 'Content-Type': 'application/json' },
         body: JSON.stringify({ input, toolId: 'ai-plagiarism-remover' })
       });
       const data = await response.json();
       return data.result || 'Rewriting failed.';
    }
  },
  {
    id: 'ai-summarizer',
    name: 'AI Text Summarizer - Instant Summary Tool Free ⚡',
    slug: 'ai-text-summarizer',
    category: 'ai',
    isAI: true,
    shortDescription: 'Summarize long articles and documents into concise key points.',
    description: 'Texly\'s AI Text Summarizer helps you save time by summarizing long articles, papers, and documents instantly. Get the core message and key points in seconds for free.',
    icon: 'FileText',
    keywords: ['ai text summarizer free', 'article summarizer online', 'summarize text with ai online', 'best free summary tool', 'tl;dr generator free'],
    example: 'Paste a long article here to get a quick summary of its contents.',
    placeholder: 'Enter long text or article content...',
    buttonText: 'Summarize ✨',
    process: async (input) => {
       const response = await fetch('/api/ai/text', {
         method: 'POST',
         headers: { 'Content-Type': 'application/json' },
         body: JSON.stringify({ input, toolId: 'ai-summarizer' })
       });
       const data = await response.json();
       return data.result || 'Summarization failed.';
    }
  },
  {
    id: 'ai-caption-generator',
    name: 'AI Social Media Caption Generator - Engagement Booster ⚡',
    slug: 'ai-caption-generator',
    category: 'ai',
    isAI: true,
    shortDescription: 'Generate catchy captions for Instagram, Facebook, and Twitter.',
    description: 'Boost your social media engagement with Texly\'s AI Caption Generator. Create witty, professional, or funny captions for your posts instantly for free.',
    icon: 'MessageSquare',
    keywords: ['ai caption generator free', 'instagram caption generator online', 'social media post captions ai', 'best free caption writer', 'facebook caption generator'],
    example: 'A beautiful sunset at the beach with soft waves.',
    placeholder: 'Describe your post or image for captions...',
    buttonText: 'Generate Captions ✨',
    process: async (input) => {
       const response = await fetch('/api/ai/text', {
         method: 'POST',
         headers: { 'Content-Type': 'application/json' },
         body: JSON.stringify({ input, toolId: 'ai-caption-generator' })
       });
       const data = await response.json();
       return data.result || 'Caption generation failed.';
    }
  },
  {
    id: 'ai-script-generator',
    name: 'AI YouTube Script Generator - Viral Content Creator ⚡',
    slug: 'ai-script-generator',
    category: 'ai',
    isAI: true,
    shortDescription: 'Create engaging scripts for your YouTube videos in seconds.',
    description: 'Plan your next viral hit with Texly\'s AI YouTube Script Generator. Get a structured script including hook, intro, and body points for any topic instantly.',
    icon: 'Video',
    keywords: ['ai youtube script generator free', 'video script creator online', 'youtube content ideas ai', 'best free script writer', 'viral video script generator'],
    example: 'How to start a successful blog in 2026.',
    ...
    process: async (input) => {
       const response = await fetch('/api/ai/text', {
         method: 'POST',
         headers: { 'Content-Type': 'application/json' },
         body: JSON.stringify({ input, toolId: 'ai-script-generator' })
       });
       const data = await response.json();
       return data.result || 'Script generation failed.';
    }
  }
];
