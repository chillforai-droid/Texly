...
export const ToolPage: React.FC = () => {
  ...
  useEffect(() => {
    if (tool) {
      ...
      document.title = `${toolName} – ${t.tool.freeOnlineTool} | Texly`;
      const metaDesc = document.querySelector('meta[name="description"]');
      if (metaDesc) {
        metaDesc.setAttribute('content', `${toolName}: ${t.toolDescriptions[tool.id] || t.tool.defaultHook}`);
      }

      // JSON-LD
      const schemas = getJSONLD(toolName, tool.slug, primaryKeyword, t);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6 tracking-tight">
            {tool.name} - {t.tool.freeOnlineTool}
          </h1>
              ...
              <div className="grid grid-cols-1 gap-8">
                ...
                <div className="flex justify-center">
                  ...
                  >
                    ...
                    <span>{loading ? t.tool.processing : (tool.buttonText || t.tool.process)}</span>
