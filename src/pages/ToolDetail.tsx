...
export const ToolPage: React.FC = () => {
  ...
  useEffect(() => {
    if (tool) {
      ...
      if (metaDesc) {
        metaDesc.setAttribute('content', `${tool.name}: ${tool.shortDescription} Free, fast, and secure online tool. No signup or installation required. Works in your browser.`);
      }
