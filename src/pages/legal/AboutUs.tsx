...
import { Zap, Shield, ZapIcon, Heart } from 'lucide-react';

const AboutUs = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <Helmet>
        <title>About Us - Texly</title>
        <meta name="description" content="Learn more about Texly, your ultimate text tools hub." />
      </Helmet>
