...
const TermsAndConditions = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <Helmet>
        <title>Terms and Conditions - Texly</title>
        <meta name="description" content="Terms and Conditions for using Texly text tools." />
      </Helmet>
      <article className="prose prose-slate max-w-none">
        <h1>Terms and Conditions</h1>
        <p>Welcome to Texly!</p>
        
        <p>These terms and conditions outline the rules and regulations for the use of Texly's Website, located at https://texly.com.</p>
