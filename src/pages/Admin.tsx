          ...
          >
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Content (Markdown/HTML Supported)</label>
                  <textarea
                    required
                    rows={15}
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <a 
                      ...
                      className="px-6 py-3 text-sm font-black text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-xl transition-all flex items-center gap-2"
                    >
