...
import { Github, Twitter, Mail, Zap, Languages, Check } from 'lucide-react';
    ...
    <LanguageProvider>
      <Router>
        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900 flex flex-col">
          ...
          {/* All Tools Directory */}
          <section aria-label="All Tools Directory" className="bg-white border-t border-slate-200 py-16">
            <div className="max-w-6xl mx-auto px-4">
              <h2 className="text-2xl font-bold text-slate-900 mb-8">All Text Tools Directory</h2>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-3" role="list">
                {ALL_TOOLS.map(tool => (
                  <Link 
                    key={tool.id} 
                    to={`/tool/${tool.slug}`} 
